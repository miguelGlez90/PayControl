        ...
        <div class="col-lg-12 col-md-12 mb-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <f:display bean="vendedor" order="['nombre', 'rfc', 'domicilioFiscal']"/>
                    <dl class="row">
                        <dt class="col-sm-3">Régimen Fiscal</dt>
                        <dd class="col-sm-9">${this.vendedor?.regimenFiscal}</dd>
                    </dl>
                    <f:display bean="vendedor" order="['fechaAlta', 'activo']"/>
                    <g:form resource="${this.vendedor}" method="DELETE">
                        <fieldset class="buttons">
                            <g:link class="btn btn-outline-primary ripple-surface ripple-surface-dark" action="edit" resource="${this.vendedor}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
