                    ...
                    <g:form resource="${this.vendedor}" method="POST">
                        <fieldset class="form">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <g:field type="text" id="rfc" maxlength="13" minlength="13" name="rfc" class="form-control" value="${this.vendedor?.rfc}" />
                            </div>
                            <f:all bean="vendedor" order="['domicilioFiscal', 'regimenFiscal']"/>
                        </fieldset>
                        <br/>
