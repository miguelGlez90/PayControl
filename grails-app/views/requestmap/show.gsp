    ...
    <div class="col-lg-12 col-md-12 mb-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <f:display bean="requestmap" />
                <g:form resource="${this.requestmap}" method="DELETE">
                    <fieldset class="buttons">
                        <g:link class="btn btn-outline-primary ripple-surface ripple-surface-dark" action="edit" resource="${this.requestmap}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
