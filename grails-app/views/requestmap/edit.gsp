...
<html>
    ...
    <body>
        ...
        <div id="edit-requestmap" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.requestmap}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.requestmap}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.requestmap}" method="PUT">
                <g:hiddenField name="version" value="${this.requestmap?.version}" />
                <fieldset class="form">
