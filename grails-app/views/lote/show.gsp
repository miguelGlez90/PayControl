            ...
            <div class="card-body">
                ...
                <g:form resource="${this.lote}" method="DELETE">
                    <fieldset class="buttons">
                        <g:link class="btn btn-outline-primary ripple-surface ripple-surface-dark" action="edit" resource="${this.lote}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
