    ...
    <div class="col-lg-12 col-md-12 mb-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <g:hasErrors bean="${this.pagoRenta}">
                    <ul class="errors" role="alert">
                        <g:eachError bean="${this.pagoRenta}" var="error">
                            <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                        </g:eachError>
                    </ul>
                </g:hasErrors>

                <g:form resource="${this.pagoRenta}" method="PUT">
                    <g:hiddenField name="version" value="${this.pagoRenta?.version}" />
                    <fieldset class="form">
                        <f:all bean="pagoRenta"/>
                    </fieldset>
